    ...
    <div>
      ...
      <main className="h-screen bg-[#C6D2D2] flex flex-row">
        ...
        <div className="w-full">
          ...
          {/*  asd */}
          <div className="bg-white  p-10 w-[60%] m-10 rounded-xl shadow-lg text-[#8FA5BD] overflow-scroll h-[700px]">
            <table className=" table-auto w-full ">
              <thead>
                <tr className=" text-center border-b  border-[#2c7fd2]">
                  <th className=" w-1/12">Codigo de Bitacora</th>
                  <th className=" w-1/6">Bitacora</th>
              ...
              <tbody>
                {bitacora.map((e, index) => (
                  ...
                  >
                    ...
                    <td className=" w-1/6">{e.bitacora} </td>

                    <td className=" w-1/6">{e.bitacora_fecha} </td>
                    <td className=" w-1/6">{e.bitacora_hora} </td>
                  </tr>
                ))}
              </tbody>
            </table>
